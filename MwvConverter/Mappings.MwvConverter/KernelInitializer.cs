...
using Logic.Business.MwvManagement;
using Logic.Domain.Kuriimu2.KomponentAdapter;
using Logic.Domain.Level5Management;
using Logic.Domain.WavManagement;

namespace Mappings.MwvConverter
{
